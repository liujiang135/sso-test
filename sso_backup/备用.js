...
module.exports.rest_api_get = function (url, headers) {
    console.log('----------common.js--rest_api_get----------')
    try {
...
module.exports.rest_api_del = function (url, headers) {
    console.log('----------common.js--rest_api_del----------')
    try {
...
module.exports.rest_api_post = function (url, headers, postdata) {
    console.log('----------common.js--rest_api_post----------')
    try {
...
module.exports.rest_api_put = function (url, headers, postdata) {
    console.log('----------common.js--rest_api_put----------')
    try {
...
module.exports.generateCode = function (len) {
    console.log('----------common.js--generateCode----------')
    len = len || 8;
...
登录网址：http://localhost:8060/login/sso
登出网址：http://localhost:8060/login/ssologout
